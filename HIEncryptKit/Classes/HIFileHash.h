 ...
 */
+ (nullable HIFileHash *)hashForFile:(NSString *)filePath types:(HIFileHashType)types;
...
/**
 ...
 @return File hash result, or nil when an error occurs.
 */
+ (nullable HIFileHash *)hashForFile:(NSString *)filePath
                               types:(HIFileHashType)types
                          usingBlock:(nullable void (^)(UInt64 totalSize, UInt64 processedSize, BOOL *stop))block;


@property (nonatomic, readonly) HIFileHashType types; ///< hash type
