...
@implementation HIFileHash

+ (HIFileHash *)hashForFile:(NSString *)filePath types:(HIFileHashType)types {
    return [self hashForFile:filePath types:types usingBlock:nil];
}

+ (HIFileHash *)hashForFile:(NSString *)filePath types:(HIFileHashType)types usingBlock:(void(^)(UInt64 totalSize, UInt64 processedSize, BOOL *stop))block {
    HIFileHash *hash = nil;
